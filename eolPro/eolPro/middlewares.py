...
class EolproDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class IPSproDownloaderMiddleware:
    ...
    def process_response(self, request, response, spider):
        ...
        # 匹配项目分页，实现动态加载数据
        if 'https://serviceexpress.com/resources/eol-eosl-database/?start' in response.url:
            logger.error("拦截响应使用selenium进行加载动态数据")
