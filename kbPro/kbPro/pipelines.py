...
from kbPro.toolclass.OperateDB import MysqlData
from kbPro.toolclass.proxy_module import GetProxy
...
class DataPipeline:
    ...
    def open_spider(self, spider):
        ...
        logger.error(self.data.field_exists(fields=vars(KbproItem)['fields']))
        spider.data_max = 0
