...
class CveprojectSpiderMiddleware:
...
class CveprojectDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class IPSproDownloaderMiddleware:
    ...
    def process_response(self, response, request, spider):
        if not (request.url in spider.failed_requests):
            spider.failed_requests.append(request.url)
        return response
