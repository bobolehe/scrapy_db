...
from cxsecurity.toolclass.OperateDB import MysqlData
from cxsecurity.toolclass.proxy_module import GetProxy
...
class DataPipeline:
    ...
    def open_spider(self, spider):
        h = GetProxy()
        settings.PROXY_HTTPS = h.run(target_url="https://cxsecurity.com/exploit/1")
        ...
        logger.error(self.data.field_exists(fields=vars(CxsecurityItem)['fields']))
        spider.data_max = 0
    ...
    def process_item(self, item, spider):
        ...
        fields = vars(CxsecurityItem)['fields']
        for field in fields:
