...
import json
import logging
from metasploit.items import MetasploitItem
from metasploit import settings
from metasploit.toolclass.OperateDB import MysqlData
from metasploit.toolclass.proxy_module import GetProxy
from metasploit.id_tool.id_seq import IdSeq
from metasploit.id_tool.id_generator import IdGenerator
...
class DataPipeline:
    ...
    def open_spider(self, spider):
        ...
        logger.error(self.data.field_exists(fields=vars(MetasploitItem)['fields']))
        spider.data_max = 0
    ...
    def process_item(self, item, spider):
        ...
        fields = vars(MetasploitItem)['fields']
        for field in fields:
